...
sdk.externalFeeds.deleteExternalFeed({
  uuid: "6fbee41f-3331-47fe-b5b6-0eb1ea426555",
...
sdk.externalFeeds.getAllExternalFeeds({
  ...
  endDate: new RFCDate("2022-07-11"),
  limit: 795535,
  offset: 171853,
  search: "blanditiis",
  sort: GetAllExternalFeedsSort.Asc,
  startDate: new RFCDate("2022-09-11"),
...
sdk.externalFeeds.getExternalFeedByUUID({
  uuid: "ed53b88f-3a8d-48f5-80b2-f2fb7b194a27",
...
sdk.externalFeeds.updateExternalFeed({
  updateExternalFeed: {
    authType: UpdateExternalFeedAuthType.Token,
    cache: true,
    headers: [
      {
        name: "userId",
  ...
  uuid: "26916fe1-f08f-4429-8e36-98f447f603e8",
