...
async function run() {
  ...
  const result = await sdk.inboundParsing.getInboundEmailAttachment({
...
async function run() {
  ...
  const result = await sdk.inboundParsing.getInboundEmailEvents({});
...
async function run() {
  ...
  const result = await sdk.inboundParsing.getInboundEmailEventsByUuid({
