...
async function run() {
  ...
  const result = await sdk.transactionalSMS.getSmsEvents({});
...
async function run() {
  ...
  const result = await sdk.transactionalSMS.getTransacAggregatedSmsReport({});
...
async function run() {
  ...
  const result = await sdk.transactionalSMS.getTransacSmsReport({});
...
async function run() {
  ...
  const result = await sdk.transactionalSMS.sendTransacSms({
