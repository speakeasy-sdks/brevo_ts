...
async function run() {
  ...
  const result = await sdk.masterAccount.deleteCorporateSubAccountId({
    id: 240183,
  });
...
async function run() {
  ...
  const result = await sdk.masterAccount.getAccountActivity({});
...
async function run() {
  ...
  const result = await sdk.masterAccount.getCorporateMasterAccount();
...
async function run() {
  ...
  const result = await sdk.masterAccount.getCorporateSubAccount({
    limit: 809548,
    offset: 775566,
  });
...
async function run() {
  ...
  const result = await sdk.masterAccount.getCorporateSubAccountId({
    id: 504418,
  });
...
```typescript
import { Brevo } from "BREVO";
import { CreateSubAccountLanguage } from "BREVO/models/components";
...
async function run() {
  ...
  const result = await sdk.masterAccount.postCorporateSubAccount({
...
async function run() {
  ...
  const result = await sdk.masterAccount.postCorporateSubAccountKey({
    id: 3232323,
    name: "My Api Key",
  });
...
```typescript
import { Brevo } from "BREVO";
import { Target } from "BREVO/models/operations";
...
async function run() {
  ...
  const result = await sdk.masterAccount.postCorporateSubAccountSsoToken({
...
async function run() {
  ...
  const result = await sdk.masterAccount.putCorporateSubAccountIdApplicationsToggle({
    id: 310762,
...
async function run() {
  ...
  const result = await sdk.masterAccount.putCorporateSubAccountIdPlan({
    id: 152623,
