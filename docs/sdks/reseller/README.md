...
(async() => {
  ...
  const res = await sdk.reseller.deleteChildDomain({
    childIdentifier: "sievert",
    domainName: "unkempt-comedy.com",
  });
...
(async() => {
  ...
  const res = await sdk.reseller.updateChildDomain({
    childIdentifier: "salty",
    domainName: "delectable-mob.name",
    updateChildDomain: {
