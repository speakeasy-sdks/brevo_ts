...
sdk.transactionalEmails.getEmailEventReport({
  ...
  endDate: "minus",
  event: GetEmailEventReportEvent.Deferred,
  limit: 675689,
  messageId: "consectetur",
  offset: 244889,
  sort: GetEmailEventReportSort.Desc,
  startDate: "ipsum",
  tags: "impedit",
  templateId: 166047,
...
sdk.transactionalEmails.getScheduledEmailById({
  endDate: new RFCDate("2021-02-26"),
  identifier: "nam",
  limit: 294076,
  offset: 482892,
  sort: GetScheduledEmailByIdSort.Asc,
  startDate: new RFCDate("2022-07-04"),
...
sdk.transactionalEmails.getSmtpReport({
  ...
  limit: 844235,
  offset: 437814,
  sort: GetSmtpReportSort.Asc,
  startDate: "voluptatibus",
  tag: "vel",
...
sdk.transactionalEmails.getTransacEmailContent({
  uuid: "10661e96-349e-41cf-9e06-e3a437000ae6",
...
sdk.transactionalEmails.getTransacEmailsList({
  email: "Gavin_Purdy70@hotmail.com",
  endDate: "deleniti",
  limit: 954334,
  messageId: "voluptate",
  offset: 351936,
