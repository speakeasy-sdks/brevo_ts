...
async function run() {
  ...
  const result = await sdk.transactionalEmails.blockNewDomain({
    domain: "example.com",
  });
...
async function run() {
  ...
  const result = await sdk.transactionalEmails.createSmtpTemplate({
...
async function run() {
  ...
  const result = await sdk.transactionalEmails.deleteBlockedDomain({
...
async function run() {
  ...
  const result = await sdk.transactionalEmails.deleteHardbounces({
    contactEmail: "alex76@example.com",
    endDate: "2017-01-31T00:00:00Z",
...
async function run() {
  ...
  const result = await sdk.transactionalEmails.deleteScheduledEmailById({
    identifier: "string",
  });
...
async function run() {
  ...
  const result = await sdk.transactionalEmails.deleteSmtpTemplate({
    templateId: 567614,
  });
...
async function run() {
  ...
  const result = await sdk.transactionalEmails.deleteSmtpBlockedContactsEmail({
...
async function run() {
  ...
  const result = await sdk.transactionalEmails.deleteSmtpLogMessageId({
    messageId: "string",
  });
...
async function run() {
  ...
  const result = await sdk.transactionalEmails.getAggregatedSmtpReport({});
...
async function run() {
  ...
  const result = await sdk.transactionalEmails.getBlockedDomains();
...
```typescript
import { Brevo } from "BREVO";
import { GetEmailEventReportQueryParamEvent, GetEmailEventReportQueryParamSort } from "BREVO/models/operations";
...
async function run() {
  ...
  const result = await sdk.transactionalEmails.getEmailEventReport({});
...
```typescript
import { Brevo } from "BREVO";
import { GetScheduledEmailByIdQueryParamSort, GetScheduledEmailByIdQueryParamStatus } from "BREVO/models/operations";
...
async function run() {
  ...
  const result = await sdk.transactionalEmails.getScheduledEmailById({
    identifier: "string",
  });
...
```typescript
import { Brevo } from "BREVO";
import { GetSmtpReportQueryParamSort } from "BREVO/models/operations";
...
async function run() {
  ...
  const result = await sdk.transactionalEmails.getSmtpReport({});
...
async function run() {
  ...
  const result = await sdk.transactionalEmails.getSmtpTemplate({
    templateId: 397488,
  });
...
```typescript
import { Brevo } from "BREVO";
import { GetSmtpTemplatesQueryParamSort } from "BREVO/models/operations";
...
async function run() {
  ...
  const result = await sdk.transactionalEmails.getSmtpTemplates({});
...
```typescript
import { Brevo } from "BREVO";
import { GetTransacBlockedContactsQueryParamSort } from "BREVO/models/operations";
...
async function run() {
  ...
  const result = await sdk.transactionalEmails.getTransacBlockedContacts({
    senders: [
      "string",
    ],
  });
...
async function run() {
  ...
  const result = await sdk.transactionalEmails.getTransacEmailContent({
...
```typescript
import { Brevo } from "BREVO";
import { GetTransacEmailsListQueryParamSort } from "BREVO/models/operations";
...
async function run() {
  ...
  const result = await sdk.transactionalEmails.getTransacEmailsList({});
...
async function run() {
  ...
  const result = await sdk.transactionalEmails.sendTestTemplate({
    sendTestEmail: {
      emailTo: [
...
async function run() {
  ...
  const result = await sdk.transactionalEmails.sendTransacEmail({
    attachment: [
      {
...
async function run() {
  ...
  const result = await sdk.transactionalEmails.updateSmtpTemplate({
    templateId: 604767,
    updateSmtpTemplate: {
      attachmentUrl: "https://attachment.domain.com",
      htmlContent: "The order n°xxxxx has been confirmed. Thanks for your purchase",
