...
```typescript
import { Brevo } from "BREVO";
import { GetEmailEventReportEvent, GetEmailEventReportSort } from "BREVO/dist/sdk/models/operations";
...
```typescript
import { Brevo } from "BREVO";
import { GetScheduledEmailByIdSort, GetScheduledEmailByIdStatus } from "BREVO/dist/sdk/models/operations";
...
```typescript
import { Brevo } from "BREVO";
import { GetSmtpReportSort } from "BREVO/dist/sdk/models/operations";
...
```typescript
import { Brevo } from "BREVO";
import { GetSmtpTemplatesSort } from "BREVO/dist/sdk/models/operations";
...
```typescript
import { Brevo } from "BREVO";
import { GetTransacBlockedContactsSort } from "BREVO/dist/sdk/models/operations";
...
```typescript
import { Brevo } from "BREVO";
import { GetTransacEmailsListSort } from "BREVO/dist/sdk/models/operations";
...
(async() => {
  ...
  const res = await sdk.transactionalEmails.sendTransacEmail({
    ...
    headers: {
      "sender.ip": "voluptatem",
      "X-Mailin-custom": "Northwest",
      "idempotencyKey": "Weber",
    },
