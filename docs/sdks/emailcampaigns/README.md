...
import { WinnerCriteria } from "BREVO/dist/models/components";
...
| ---------------------------------------------------------------------------- | ---------------------------------------------------------------------------- | ---------------------------------------------------------------------------- | ---------------------------------------------------------------------------- |
| `request`                                                                    | [components.CreateEmailCampaign](../../models/shared/createemailcampaign.md) | :heavy_check_mark:                                                           | The request object to use for the request.                                   |
...
```typescript
import { Brevo } from "BREVO";
import { RecipientsType } from "BREVO/dist/models/components";
...
```typescript
import { Brevo } from "BREVO";
import { Statistics } from "BREVO/dist/models/operations";
...
import {
  ...
  Status,
  TypeT,
} from "BREVO/dist/models/operations";
...
```typescript
import { Brevo } from "BREVO";
import { UpdateEmailCampaignWinnerCriteria } from "BREVO/dist/models/components";
...
| Parameter                                                                      | Type                                                                           | Required                                                                       | Description                                                                    |
| ------------------------------------------------------------------------------ | ------------------------------------------------------------------------------ | ------------------------------------------------------------------------------ | ------------------------------------------------------------------------------ |
| `request`                                                                      | [components.UploadImageToGallery](../../models/shared/uploadimagetogallery.md) | :heavy_check_mark:                                                             | The request object to use for the request.                                     |
| `config`                                                                       | [AxiosRequestConfig](https://axios-http.com/docs/req_config)                   | :heavy_minus_sign:                                                             | Available config options for making requests.                                  |
