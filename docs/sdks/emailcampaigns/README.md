...
sdk.emailCampaigns.getEmailCampaign({
  campaignId: 715666,
  statistics: GetEmailCampaignStatistics.GlobalStats,
...
sdk.emailCampaigns.getEmailCampaigns({
  ...
  startDate: "Dynamic metrics",
  statistics: GetEmailCampaignsStatistics.StatsByDomain,
  status: GetEmailCampaignsStatus.Suspended,
...
sdk.emailCampaigns.updateCampaignStatus({
  campaignId: 859791,
  updateCampaignStatus: {
    status: UpdateCampaignStatusStatus.ReplicateTemplate,
  },
