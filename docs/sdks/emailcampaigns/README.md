...
sdk.emailCampaigns.getEmailCampaign({
  campaignId: 633931,
  statistics: GetEmailCampaignStatistics.StatsByDevice,
...
sdk.emailCampaigns.getEmailCampaigns({
  endDate: "recusandae",
  excludeHtmlContent: GetEmailCampaignsExcludeHTMLContent.False,
  limit: 853940,
  offset: 424089,
  sort: GetEmailCampaignsSort.Asc,
  startDate: "quos",
  statistics: GetEmailCampaignsStatistics.LinksStats,
  status: GetEmailCampaignsStatus.Archive,
  type: GetEmailCampaignsType.Trigger,
...
sdk.emailCampaigns.updateCampaignStatus({
  campaignId: 828657,
  updateCampaignStatus: {
    status: UpdateCampaignStatusStatus.Darchive,
  },
