...
async function run() {
  ...
  const result = await sdk.senders.createSender({
...
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | [components.CreateSender](../../models/components/createsender.md)                                                                                                             | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
...
async function run() {
  ...
  const result = await sdk.senders.deleteSender({
    senderId: 234732,
  });
...
async function run() {
  ...
  const result = await sdk.senders.getIps();
...
async function run() {
  ...
  const result = await sdk.senders.getIpsFromSender({
    senderId: 848663,
  });
...
async function run() {
  ...
  const result = await sdk.senders.getSenders({});
...
async function run() {
  ...
  const result = await sdk.senders.updateSender({
    senderId: 616420,
    updateSender: {
      email: "newsletter@mycompany.com",
      ips: [
...
async function run() {
  ...
  const result = await sdk.senders.validateSenderByOTP({
    otp: {
      otp: 123456,
    },
    senderId: 499324,
