...
| ---------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------- |
| `request`                                                                          | [components.CreateWhatsAppCampaign](../../models/shared/createwhatsappcampaign.md) | :heavy_check_mark:                                                                 | The request object to use for the request.                                         |
...
```typescript
import { Brevo } from "BREVO";
import { Category } from "BREVO/dist/models/components";
...
| Parameter                                                                          | Type                                                                               | Required                                                                           | Description                                                                        |
| ---------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------- |
| `request`                                                                          | [components.CreateWhatsAppTemplate](../../models/shared/createwhatsapptemplate.md) | :heavy_check_mark:                                                                 | The request object to use for the request.                                         |
| `config`                                                                           | [AxiosRequestConfig](https://axios-http.com/docs/req_config)                       | :heavy_minus_sign:                                                                 | Available config options for making requests.                                      |
...
```typescript
import { Brevo } from "BREVO";
import { GetWhatsAppCampaignsQueryParamSort } from "BREVO/dist/models/operations";
...
```typescript
import { Brevo } from "BREVO";
import { GetWhatsAppTemplatesQueryParamSort } from "BREVO/dist/models/operations";
...
```typescript
import { Brevo } from "BREVO";
import { UpdateWhatsAppCampaignCampaignStatus } from "BREVO/dist/models/components";
