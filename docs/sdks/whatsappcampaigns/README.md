...
async function run() {
  ...
  const result = await sdk.whatsAppCampaigns.createWhatsAppCampaign({
    name: "Test Campaign",
    recipients: {
      excludedListIds: [
        8,
...
async function run() {
  ...
  const result = await sdk.whatsAppCampaigns.createWhatsAppTemplate({
...
async function run() {
  ...
  const result = await sdk.whatsAppCampaigns.deleteWhatsAppCampaign({
    campaignId: 789504,
  });
...
async function run() {
  ...
  const result = await sdk.whatsAppCampaigns.getWhatsAppCampaign({
    campaignId: 179428,
  });
...
async function run() {
  ...
  const result = await sdk.whatsAppCampaigns.getWhatsAppCampaigns({});
...
async function run() {
  ...
  const result = await sdk.whatsAppCampaigns.getWhatsAppConfig();
...
async function run() {
  ...
  const result = await sdk.whatsAppCampaigns.getWhatsAppTemplates({});
...
async function run() {
  ...
  const result = await sdk.whatsAppCampaigns.sendWhatsAppTemplateApproval({
    templateId: 576759,
  });
...
async function run() {
  ...
  const result = await sdk.whatsAppCampaigns.updateWhatsAppCampaign({
    campaignId: 898516,
    updateWhatsAppCampaign: {
