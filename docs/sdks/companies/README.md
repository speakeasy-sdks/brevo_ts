...
async function run() {
  ...
  const result = await sdk.companies.deleteCompaniesId({
    id: "<ID>",
  });
...
```typescript
import { Brevo } from "BREVO";
import { Sort } from "BREVO/models/operations";
...
async function run() {
  ...
  const result = await sdk.companies.getCompanies({});
...
async function run() {
  ...
  const result = await sdk.companies.getCompaniesAttributes();
...
async function run() {
  ...
  const result = await sdk.companies.getCompaniesId({
    id: "<ID>",
  });
...
async function run() {
  ...
  const result = await sdk.companies.patchCompaniesLinkUnlinkId({
    requestBody: {
      linkContactIds: [
        1,
        2,
...
async function run() {
  ...
  const result = await sdk.companies.patchCompaniesId({
    requestBody: {
      attributes: {},
      countryCode: 91,
      name: "company",
...
async function run() {
  ...
  const result = await sdk.companies.postCompanies({
    attributes: {},
    countryCode: 91,
    name: "company",
  });
