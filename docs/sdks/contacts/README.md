...
sdk.contacts.getContactInfo({
  endDate: "array Cayman up",
  identifier: "Recycled",
  startDate: "Arkansas Imani",
...
sdk.contacts.getContactStats({
  endDate: "Bicycle North bluetooth",
  identifier: 857458,
  startDate: "North",
...
sdk.contacts.getContacts({
  createdSince: "Hip Shirt orange",
  limit: 120432,
  modifiedSince: "incubate",
  offset: 609746,
  sort: GetContactsSort.Asc,
...
sdk.contacts.getContactsFromList({
  limit: 164358,
  listId: 721707,
  modifiedSince: "monitor",
  offset: 980962,
  sort: GetContactsFromListSort.Asc,
  ...
  jsonBody: [
    {
      ...
      email: "Hertha.Strosin4@gmail.com",
    },
  ],
  listIds: [
    76,
...
sdk.contacts.requestContactExport({
  customContactFilter: {
    ...
    actionForEmailCampaigns: RequestContactExportCustomContactFilterActionForEmailCampaigns.NonClickers,
...
sdk.contacts.updateContact({
  identifier: "overriding intranet",
  updateContact: {
    attributes: {
      "modi": "nor",
    },
