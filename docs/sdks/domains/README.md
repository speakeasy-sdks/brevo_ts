...
async function run() {
  ...
  const result = await sdk.domains.authenticateDomain({
...
async function run() {
  ...
  const result = await sdk.domains.deleteDomain({
...
async function run() {
  ...
  const result = await sdk.domains.getDomainConfiguration({
...
async function run() {
  ...
  const result = await sdk.domains.getDomains();
