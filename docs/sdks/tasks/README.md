...
async function run() {
  ...
  const result = await sdk.tasks.deleteCrmTasksId({
    id: "<id>",
  });
...
async function run() {
  ...
  const result = await sdk.tasks.getCrmTasks({});
...
async function run() {
  ...
  const result = await sdk.tasks.getCrmTasksId({
    id: "<id>",
  });
...
async function run() {
  ...
  const result = await sdk.tasks.getCrmTasktypes();
...
```typescript
import { Brevo } from "BREVO";
import { Types, Unit } from "BREVO/models/components";
...
async function run() {
  ...
  const result = await sdk.tasks.patchCrmTasksId({
    requestBody: {
...
async function run() {
  ...
  const result = await sdk.tasks.postCrmTasks({
    assignToId: "5faab4b7f195bb3c4c31e62a",
    companiesIds: [
      "61a5ce58c5d4795761045990",
      "61a5ce58c5d4795761045991",
