...
async function run() {
  ...
  const result = await sdk.ecommerce.createBatchOrder({
...
async function run() {
  ...
  const result = await sdk.ecommerce.createOrder({
    amount: 308.42,
    billing: {
      address: "15 Somewhere Road, Brynmenyn",
      city: "Basel",
...
async function run() {
  ...
  const result = await sdk.ecommerce.createUpdateBatchCategory({
    categories: [
      {
...
async function run() {
  ...
  const result = await sdk.ecommerce.createUpdateBatchProducts({
    products: [
      {
        categories: [
          "<value>",
...
async function run() {
  ...
  const result = await sdk.ecommerce.createUpdateCategory({
    deletedAt: "2017-05-12T12:30:00Z",
    id: "CAT123",
    name: "Electronics",
    updateEnabled: false,
...
async function run() {
  ...
  const result = await sdk.ecommerce.createUpdateProduct({
    categories: [
      "<value>",
    ],
    id: "P11",
...
async function run() {
  ...
  const result = await sdk.ecommerce.getCategories({
    ids: [
      "<value>",
    ],
  });
...
async function run() {
  ...
  const result = await sdk.ecommerce.getCategoryInfo({
    id: "<id>",
  });
...
async function run() {
  ...
  const result = await sdk.ecommerce.getProductInfo({
    id: "<id>",
  });
...
async function run() {
  ...
  const result = await sdk.ecommerce.postEcommerceActivate();
