...
sdk.deals.getCrmDeals({
  filtersAttributesDealName: "green Research definition",
  filtersLinkedCompaniesIds: "gorilla qui Maryland",
  filtersLinkedContactsIds: "Amarillo Spring",
  limit: 75516,
  offset: 219145,
  sort: GetCrmDealsSort.Asc,
...
sdk.deals.getCrmPipelineDetailsPipelineID({
  pipelineID: "Avon Executive indexing",
