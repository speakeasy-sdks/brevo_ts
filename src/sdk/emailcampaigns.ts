...
export class EmailCampaigns extends ClientSDK {
    ...
    async getAbTestCampaignResult(
        ...
        const path = this.templateURLComponent("/emailCampaigns/{campaignId}/abTestCampaignResult")(
            pathParams
        );
    ...
    async sendEmailCampaignNow(
        ...
        const path = this.templateURLComponent("/emailCampaigns/{campaignId}/sendNow")(pathParams);
    ...
    async sendTestEmail(
        ...
        const path = this.templateURLComponent("/emailCampaigns/{campaignId}/sendTest")(pathParams);
