...
export class SMSCampaigns extends ClientSDK {
    ...
    async requestSmsRecipientExport(
        ...
        const body = enc$.encodeJSON("body", payload.requestSmsRecipientExport, { explode: true });
    ...
    async sendSmsReport(
        ...
        const path = this.templateURLComponent("/smsCampaigns/{campaignId}/sendReport")(pathParams);
    ...
    async sendTestSms(
        ...
        if (this.matchStatusCode(response, 204)) {
            ...
            throw new errors.PostSendSmsTestFailed(result);
