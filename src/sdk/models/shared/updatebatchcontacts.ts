...
export class UpdateBatchContactsContacts extends SpeakeasyBase {
    /**
...
export class UpdateBatchContacts extends SpeakeasyBase {
    /**
     * List of contacts to be updated
     */
    @SpeakeasyMetadata({ elemType: UpdateBatchContactsContacts })
    @Expose({ name: "contacts" })
    @Type(() => UpdateBatchContactsContacts)
    contacts?: UpdateBatchContactsContacts[];
}
