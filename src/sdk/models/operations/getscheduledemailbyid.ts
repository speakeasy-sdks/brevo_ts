 ...
 */
export enum GetScheduledEmailByIdSort {
    Asc = "asc",
    Desc = "desc",
}
 ...
 */
export enum GetScheduledEmailByIdStatus {
    Processed = "processed",
...
export class GetScheduledEmailByIdRequest extends SpeakeasyBase {
    ...
    sort?: GetScheduledEmailByIdSort;
    ...
    status?: GetScheduledEmailByIdStatus;
}
...
export class GetScheduledEmailByIdResponse extends SpeakeasyBase {
     ...
     */
    @SpeakeasyMetadata()
    getScheduledEmailById200ApplicationJSONOneOf?: any;
}
