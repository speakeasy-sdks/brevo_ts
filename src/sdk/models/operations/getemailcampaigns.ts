 ...
 */
export enum GetEmailCampaignsExcludeHTMLContent {
    True = "true",
    False = "false",
}
 ...
 */
export enum GetEmailCampaignsSort {
    Asc = "asc",
    Desc = "desc",
}
 ...
 */
export enum GetEmailCampaignsStatistics {
...
export class GetEmailCampaignsRequest extends SpeakeasyBase {
    ...
    excludeHtmlContent?: GetEmailCampaignsExcludeHTMLContent;
...
export class GetEmailCampaignsResponse extends SpeakeasyBase {
     ...
     */
    @SpeakeasyMetadata()
    getEmailCampaigns?: shared.GetEmailCampaigns;
}
