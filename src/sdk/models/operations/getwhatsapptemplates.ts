 ...
 */
export enum GetWhatsAppTemplatesSort {
    Asc = "asc",
    Desc = "desc",
}

export class GetWhatsAppTemplatesRequest extends SpeakeasyBase {
    /**
...
export class GetWhatsAppTemplatesResponse extends SpeakeasyBase {
    /**
     ...
     */
    @SpeakeasyMetadata()
    getWhatsappTemplates?: shared.GetWhatsappTemplates;
}
