 ...
 * Filter by date
 */
export enum GetCrmTasksFilterDate {
    Overdue = "overdue",
    Today = "today",
    Tomorrow = "tomorrow",
    Week = "week",
 ...
 */
export enum GetCrmTasksFilterStatus {
    Done = "done",
    Undone = "undone",
}
...
export class GetCrmTasksRequest extends SpeakeasyBase {
    ...
    filterDate?: GetCrmTasksFilterDate;
    ...
    filterStatus?: GetCrmTasksFilterStatus;
