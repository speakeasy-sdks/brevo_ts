...
export class Contacts extends ClientSDK {
    ...
    async addContactToList(
        ...
        const path = this.templateURLComponent("/contacts/lists/{listId}/contacts/add")(pathParams);
    ...
    async getContactStats(
        ...
        const path = this.templateURLComponent("/contacts/{identifier}/campaignStats")(pathParams);
