...
export type CreateUpdateProductsMetaInfo = string | number;
...
/** @internal */
export namespace CreateUpdateProductsMetaInfo$ {
    export type Inbound = string | number;

    export type Outbound = string | number;

    export const inboundSchema: z.ZodType<CreateUpdateProductsMetaInfo, z.ZodTypeDef, Inbound> =
        z.union([z.string(), z.number().int()]);

    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, CreateUpdateProductsMetaInfo> =
        z.union([z.string(), z.number().int()]);
}
