 ...
 */
export type GetProductDetailsMetaInfo = {};
...
export type GetProductDetails = {
     ...
     * Meta data of product such as description, vendor, producer, stock level, etc.
     */
    metaInfo?: GetProductDetailsMetaInfo | undefined;
    /**
...
/** @internal */
export namespace GetProductDetailsMetaInfo$ {
    export type Inbound = {};

    export const inboundSchema: z.ZodType<GetProductDetailsMetaInfo, z.ZodTypeDef, Inbound> =
        z.object({});

    export type Outbound = {};

    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, GetProductDetailsMetaInfo> =
        z.object({});
}
...
export namespace GetProductDetails$ {
    export type Inbound = {
        ...
        imageUrl?: string | undefined;
        isDeleted?: boolean | undefined;
        metaInfo?: GetProductDetailsMetaInfo$.Inbound | undefined;
        modifiedAt: string;
        name: string;
        parentId?: string | undefined;
        price?: number | undefined;
    ...
    export const inboundSchema: z.ZodType<GetProductDetails, z.ZodTypeDef, Inbound> = z
        .object({
            ...
            metaInfo: z.lazy(() => GetProductDetailsMetaInfo$.inboundSchema).optional(),
            modifiedAt: z.string(),
            name: z.string(),
    ...
    export type Outbound = {
        ...
        imageUrl?: string | undefined;
        isDeleted?: boolean | undefined;
        metaInfo?: GetProductDetailsMetaInfo$.Outbound | undefined;
        modifiedAt: string;
        name: string;
        parentId?: string | undefined;
        price?: number | undefined;
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, GetProductDetails> = z
        .object({
            ...
            imageUrl: z.string().optional(),
            isDeleted: z.boolean().optional(),
            metaInfo: z.lazy(() => GetProductDetailsMetaInfo$.outboundSchema).optional(),
            modifiedAt: z.string(),
            name: z.string(),
            parentId: z.string().optional(),
            price: z.number().optional(),
