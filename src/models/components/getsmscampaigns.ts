...
export class GetSmsCampaignsRecipients extends SpeakeasyBase {
    @SpeakeasyMetadata()
...
export class GetSmsCampaignsStatistics extends SpeakeasyBase {
    /**
...
export class GetSmsCampaignsCampaigns extends SpeakeasyBase {
    ...
    @Type(() => GetSmsCampaignsRecipients)
    ...
    @Type(() => GetSmsCampaignsStatistics)
