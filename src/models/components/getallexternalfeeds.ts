...
export class GetAllExternalFeedsHeaders extends SpeakeasyBase {
    /**
     * Name of the header
     */
    @SpeakeasyMetadata()
...
export class Feeds extends SpeakeasyBase {
    /**
     * Auth type of the feed: * `basic` * `token` * `noAuth`
     *
     * @remarks
     ...
     */
    @SpeakeasyMetadata({ elemType: GetAllExternalFeedsHeaders })
    @Expose({ name: "headers" })
    @Type(() => GetAllExternalFeedsHeaders)
    headers: GetAllExternalFeedsHeaders[];
...
export class GetAllExternalFeeds extends SpeakeasyBase {
    ...
    @SpeakeasyMetadata({ elemType: Feeds })
    @Expose({ name: "feeds" })
    @Type(() => Feeds)
    feeds?: Feeds[];
}
