...
export class GetEmailCampaignCampaignStats extends SpeakeasyBase {
    /**
 ...
 */
export class GlobalStats extends SpeakeasyBase {
    /**
     * Number of total clicks for the campaign
     */
    @SpeakeasyMetadata()
 ...
 */
export class LinksStats extends SpeakeasyBase {}

export class GetEmailCampaignStatistics extends SpeakeasyBase {
    /**
     * List-wise statistics of the campaign.
     */
    @SpeakeasyMetadata({ elemType: GetEmailCampaignCampaignStats })
    @Expose({ name: "campaignStats" })
    @Type(() => GetEmailCampaignCampaignStats)
    campaignStats: GetEmailCampaignCampaignStats[];
