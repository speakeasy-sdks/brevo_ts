 ...
 *
 */
export type CreateSmtpTemplateSender = {
    /**
     * Email of the sender
     */
...
export type CreateSmtpTemplate = {
    /**
...
/** @internal */
export namespace CreateSmtpTemplateSender$ {
    export type Inbound = {
        email?: string | undefined;
        id?: number | undefined;
        name?: string | undefined;
    ...
    export const inboundSchema: z.ZodType<CreateSmtpTemplateSender, z.ZodTypeDef, Inbound> = z
        .object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, CreateSmtpTemplateSender> = z
        .object({
            email: z.string().optional(),
            id: z.number().int().optional(),
            name: z.string().optional(),
...
/** @internal */
export namespace CreateSmtpTemplate$ {
    export type Inbound = {
        attachmentUrl?: string | undefined;
        htmlContent?: string | undefined;
        htmlUrl?: string | undefined;
        isActive?: boolean | undefined;
        replyTo?: string | undefined;
        sender: CreateSmtpTemplateSender$.Inbound;
        subject: string;
        tag?: string | undefined;
        templateName: string;
        toField?: string | undefined;
    ...
    export const inboundSchema: z.ZodType<CreateSmtpTemplate, z.ZodTypeDef, Inbound> = z
        .object({
            ...
            sender: z.lazy(() => CreateSmtpTemplateSender$.inboundSchema),
            subject: z.string(),
    ...
    export type Outbound = {
        ...
        isActive?: boolean | undefined;
        replyTo?: string | undefined;
        sender: CreateSmtpTemplateSender$.Outbound;
        subject: string;
        tag?: string | undefined;
        templateName: string;
        toField?: string | undefined;
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, CreateSmtpTemplate> = z
        .object({
            attachmentUrl: z.string().optional(),
            htmlContent: z.string().optional(),
            htmlUrl: z.string().optional(),
            isActive: z.boolean().optional(),
            replyTo: z.string().optional(),
            sender: z.lazy(() => CreateSmtpTemplateSender$.outboundSchema),
            subject: z.string(),
            tag: z.string().optional(),
            templateName: z.string(),
            toField: z.string().optional(),
