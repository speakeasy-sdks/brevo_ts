...
export type GetCrmPipelineDetailsAllResponse = {
    /**
...
/** @internal */
export namespace GetCrmPipelineDetailsAllResponse$ {
    export type Inbound = {
        ContentType: string;
    ...
    export const inboundSchema: z.ZodType<GetCrmPipelineDetailsAllResponse, z.ZodTypeDef, Inbound> =
        z
            .object({
