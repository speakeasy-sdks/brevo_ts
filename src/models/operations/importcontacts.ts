...
/** @internal */
export namespace ImportContactsResponse$ {
    export type Inbound = {
        ContentType: string;
        StatusCode: number;
        RawResponse: Response;
    ...
    export const inboundSchema: z.ZodType<ImportContactsResponse, z.ZodTypeDef, Inbound> = z
        .object({
    ...
    export const outboundSchema: z.ZodType<Outbound, z.ZodTypeDef, ImportContactsResponse> = z
        .object({
            contentType: z.string(),
            statusCode: z.number().int(),
