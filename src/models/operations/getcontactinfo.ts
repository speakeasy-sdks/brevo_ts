...
export class GetContactInfoRequest extends SpeakeasyBase {
    /**
...
export class GetContactInfoResponse extends SpeakeasyBase {
    /**
     ...
     */
    @SpeakeasyMetadata()
    getExtendedContactDetails?: components.GetExtendedContactDetails;
}
